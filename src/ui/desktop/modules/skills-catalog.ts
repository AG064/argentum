...
export interface CatalogSkill {
  /** Unique slug — must be valid folder name */
  name: string;
...
// These skills are bundled with Argentum and installed as part of the standard
// Argentum setup. They are maintained as part of the Argentum release.
// The catalog also includes the upstream Anthropic/Codex versions for reference.

const ARGENTUM_BUNDLED_SKILLS: CatalogSkill[] = [
  {
    name: 'argentum-docx',
    description:
      'Create, read, edit, and analyze Word documents (.docx). Handles reports, memos, letters, templates, tables of contents, headings, page numbers, image insertion, find-and-replace, tracked changes, and conversions from other formats.',
    source: 'argentum',
    category: 'document',
    tags: ['word', 'docx', 'document', 'office'],
    builtinNote:
      'Bundled with Argentum. Installed and maintained automatically as part of the Argentum release — no separate install needed.',
  },
  {
    name: 'argentum-pdf',
    description:
      'Process PDF files — read/extract text and tables, combine/merge/split PDFs, rotate pages, add watermarks, create new PDFs, fill forms, encrypt/decrypt, extract images, and OCR scanned documents.',
    source: 'argentum',
    category: 'document',
    tags: ['pdf', 'document', 'ocr', 'forms'],
    builtinNote:
      'Bundled with Argentum. Installed and maintained automatically as part of the Argentum release — no separate install needed.',
  },
  {
    name: 'argentum-pptx',
    description:
      'Create and edit PowerPoint presentations (.pptx/.pptm). Build slide decks with professional layouts, themes, animations, speaker notes, charts, and multimedia content.',
    source: 'argentum',
    category: 'document',
  ...
  },
  {
    name: 'argentum-xlsx',
    description:
      'Create and edit Excel spreadsheets (.xlsx/.xlsm). Build data models, pivot tables, charts, formulas, conditional formatting, and multi-sheet workbooks.',
    source: 'argentum',
    category: 'document',
...
const ANTHROPIC_SKILLS: CatalogSkill[] = [
  {
    name: 'theme-factory',
    description:
      'Apply consistent, professional styling to any artifact — slides, docs, reports, HTML pages. Choose from 10 pre-set themes with curated color palettes and font pairings, or generate a custom theme on the fly.',
    source: 'anthropic',
  ...
  },
  {
    name: 'internal-comms',
    description:
      'Draft professional internal communications — team announcements, project updates, org-wide memos. Uses company-specific voice and format guidelines for clear, consistent internal messaging.',
    source: 'anthropic',
    repo: 'anthropics/skills',
  ...
  },
  {
    ...
    description:
      'Build rich web artifacts — interactive visualizations, data dashboards, and polished HTML presentations. Creates self-contained HTML pages with embedded CSS and JavaScript.',
    source: 'anthropic',
    repo: 'anthropics/skills',
...
const CODEX_CURATED_SKILLS: CatalogSkill[] = [
  {
    name: 'figma-use',
    description:
      'MANDATORY prerequisite for every Figma plugin API call. Covers JavaScript execution in Figma files via the Plugin API — create/edit/delete nodes, set variables, build components, modify auto-layout, and inspect file structure programmatically.',
    source: 'codex',
    repo: 'openai/skills',
  ...
  },
  {
    ...
    description:
      'Build full pages and screens in Figma from code. Use with figma-use — discover design system components, import them, and assemble screens incrementally using the Figma Plugin API.',
    source: 'codex',
    repo: 'openai/skills',
  ...
  },
  {
    ...
    description:
      'Initialize new Figma files with proper structure — pages, frames, grids, and design system foundations. Sets up a clean starting point for new design projects.',
    source: 'codex',
    repo: 'openai/skills',
  ...
  },
  {
    name: 'playwright',
    description:
      'Automate real browsers from the terminal — navigation, form filling, snapshots, screenshots, and data extraction via playwright-cli or bundled wrapper scripts.',
    source: 'codex',
    repo: 'openai/skills',
  ...
  },
  {
    name: 'pdf',
    description:
      'Process PDF files — extraction, merging, splitting, watermarking, form filling, OCR, and text analysis. Uses Python libraries and command-line tools.',
    source: 'codex',
    repo: 'openai/skills',
  ...
  },
  {
    name: 'yeet',
    description:
      'Quick-launch skill for common dev tasks — scaffolding projects, spinning up dev servers, running tests, and deploying from a single command.',
    source: 'codex',
    repo: 'openai/skills',
...
const CODEX_SYSTEM_SKILLS: CatalogSkill[] = [
  {
    name: 'imagegen',
    description:

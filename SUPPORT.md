...
Argentum follows semantic versioning (SemVer). Only the latest minor version in the current major version receives active support. Major version bumps introduce breaking changes.
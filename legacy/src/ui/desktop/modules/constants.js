...
export const modelMetadata = {
  ...
  'qwen/qwen3.5-0.8b-instruct': {
    ...
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Small current Qwen3.5 local profile.',
    capabilities: ['local chat', 'routing', 'fast responses'],
    detail: 'Very small instruction model for quick local chat and lightweight routing.',
  },
  'google/gemma-4-e2b-it': {
    maxContextTokens: 131000,
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Newest compact Gemma 4 multimodal profile.',
    capabilities: ['local chat', 'vision', 'image understanding', 'audio on supported variants'],
    detail: 'Compact Gemma 4 any-to-any model for text and multimodal input through llama.cpp.',
  },
  'google/gemma-4-e4b-it': {
    maxContextTokens: 131000,
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Current mid-size Gemma 4 multimodal profile.',
    capabilities: ['local chat', 'vision', 'reasoning', 'multimodal input'],
    detail: 'Mid-size Gemma 4 any-to-any model for stronger local reasoning and multimodal work.',
  },
  'google/gemma-3-4b-it': {
    maxContextTokens: 32768,
    contextWindow: '32k native for 4B',
    maxContextWindow: '128k model context',
    currentContextLabel: 'Multimodal local profile. Requires a matching mmproj for image input.',
    capabilities: ['local chat', 'vision', 'image understanding'],
    detail:
      'Text and image understanding model. llama.cpp can load the matching vision projector from Hugging Face.',
  },
  'qwen/qwen3-4b': {
    maxContextTokens: 32768,
    contextWindow: '32k native',
    maxContextWindow: '131k with YaRN',
    currentContextLabel: 'Mid-size Qwen3 local profile.',
    capabilities: ['local chat', 'reasoning', 'coding', 'tools'],
    detail: 'Balanced mid-size model for reasoning, coding, multilingual chat, and tool use.',
  },
  'qwen/qwen3-coder-30b-a3b-instruct': {
    maxContextTokens: 131000,
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Large coding-focused local profile.',
    capabilities: ['local coding', 'repository work', 'agent tools'],
    detail: 'Mixture-of-experts coding model intended for demanding software engineering tasks.',
  },
  'qwen/qwen3.5-35b-a3b': {
    maxContextTokens: 131000,
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Large local profile. Hardware requirements are high.',
    capabilities: ['local reasoning', 'coding', 'agent tools', 'long tasks'],
    detail: 'Large mixture-of-experts model for demanding local reasoning and agent workloads.',
  },
  'qwen/qwen3.6-35b-a3b': {
    maxContextTokens: 131000,
    contextWindow: 'Model dependent',
    maxContextWindow: 'Model dependent',
    currentContextLabel: 'Newest large Qwen3.6 local profile.',
    capabilities: ['local reasoning', 'coding', 'vision', 'agent tools', 'long tasks'],
    detail:
      'Large Qwen3.6 model for demanding reasoning and agent workloads. Hardware requirements are high.',
  },
  'custom-local-model': {
    maxContextTokens: 32000,
...
export const providerCatalogTabs = [
  {
    ...
    label: 'Primary',
    detail:
      'Provider routes with live chat and connection tests. Test your credentials before use.',
  },
  {
    id: 'testing',
    label: 'More providers',
    detail: 'Additional routes that must pass Test Provider before live use.',
  },
];
...
export const llamaDownloadPresets = [
  {
    ...
    license: 'Apache-2.0',
    role: 'text',
    repo: 'Qwen/Qwen3-0.6B-GGUF:Q4_K_M',
    file: 'Qwen3-0.6B-Q4_K_M.gguf',
    detail: 'Latest compact general text and reasoning model for low-resource machines.',
  },
  {
    id: 'qwen3.5-0.8b-q4',
    modelId: 'qwen/qwen3.5-0.8b-instruct',
    label: 'Qwen3.5 0.8B Instruct',
    size: '0.8B',
    license: 'Apache-2.0',
    role: 'text',
    repo: 'ggml-org/Qwen3.5-0.8B-GGUF:Q4_K_M',
    file: 'Qwen3.5-0.8B-Q4_K_M.gguf',
    detail: 'Very small current Qwen3.5 instruction model for fast local chat and routing.',
  },
  {
    ...
    license: 'Gemma Terms',
    role: 'image',
    repo: 'ggml-org/gemma-4-E2B-it-GGUF:Q4_0',
    file: 'gemma-4-E2B-it-Q4_0.gguf',
    detail:
      'Newest compact multimodal model for text and image understanding. llama.cpp resolves its matching projector.',
  },
  {
    ...
    license: 'Gemma Terms',
    role: 'mid',
    repo: 'ggml-org/gemma-4-E4B-it-GGUF:Q4_0',
    file: 'gemma-4-E4B-it-Q4_0.gguf',
    detail: 'Current mid-size any-to-any model for text, reasoning, and multimodal tasks.',
  },
  {
    ...
    license: 'Apache-2.0',
    role: 'coder',
    repo: 'tensorblock/Qwen_Qwen3-Coder-30B-A3B-Instruct-GGUF:Q4_K_M',
    file: 'Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf',
    detail: 'Code-focused mixture-of-experts model for repository work and software engineering.',
  },
  {
    ...
    license: 'Apache-2.0',
    role: 'big',
    repo: 'ggml-org/Qwen3.6-35B-A3B-GGUF:Q4_K_M',
    file: '',
    detail:
      'Newest large local model for demanding reasoning and agent tasks. Requires substantial RAM or VRAM.',
  },
];
